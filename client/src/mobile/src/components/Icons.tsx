...
export const ShoppingBagIcon: React.FC<IconProps> = ({ size = 20, color = 'currentColor', className }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" className={className}>
...
export const StarIcon: React.FC<IconProps> = ({ size = 20, color = 'currentColor', className, filled = false }) => (
